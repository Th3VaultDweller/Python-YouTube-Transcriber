...
def download_audio():
    ...
    video_urls = []
    url = input("Вставьте ссылку на видео: ")
    video_urls.append(url)

    # указываем папку для сохранённых аудиофайлов и скачиваем файл
    destination = input("Укажите полный путь сохранения аудиофайла: ")
...
# def make_meta_table():
#     """Создаёт метаразметку в соответствии с вводом информации от пользователя"""
...
def transcribe_audio():
    ...
    model = whisper.load_model(
        input("Укажите название модели (tiny, base, small, medium или large): ")
    )

    # определяем папку со скачанными файлами

    root_folder = input("Укажите полный путь к скачанным файлам: ")
...
# def make_new_line():
#     """Переносит каждое предложение в файле после точки на новую строку"""
